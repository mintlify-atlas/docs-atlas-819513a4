...
description: "A grid list component with clickable cards containing avatar images."
---
...
```bash pnpm
pnpm dlx shadcn@latest add https://blocks.so/r/grid-list-02.json
```
...
```bash bun
bunx shadcn@latest add https://blocks.so/r/grid-list-02.json
```
</CodeGroup>
