...
description: "A registration form layout with workspace fields, address inputs, and action buttons."
---

A clean and organized form layout for workspace registration with personal details, address fields, and form controls.

## Installation

<CodeGroup>
```bash npm
npx shadcn@latest add @blocks/form-layout-01
```

```bash yarn
yarn dlx shadcn@latest add @blocks/form-layout-01
```

```bash pnpm
pnpm dlx shadcn@latest add @blocks/form-layout-01
```

```bash bun
bunx shadcn@latest add @blocks/form-layout-01
```
</CodeGroup>
...
- Visual separator between form fields and actions
