...
description: "An application form with workspace package selection using interactive radio cards."
---

An early access application form featuring personal details and an interactive workspace package selector with pricing tiers.

## Installation

<CodeGroup>
```bash npm
npx shadcn@latest add @blocks/form-layout-04
```

```bash yarn
yarn dlx shadcn@latest add @blocks/form-layout-04
```

```bash pnpm
pnpm dlx shadcn@latest add @blocks/form-layout-04
```

```bash bun
bunx shadcn@latest add @blocks/form-layout-04
```
</CodeGroup>
...
- Personal information fields (first name, last name, work email)
- Company information with company name and size selector
- Interactive package selection with radio cards
- Three pricing tiers: Starter (Free), Premium ($900/month), and Enterprise (Custom)
- Visual card design for package options
- Required field indicators
- Footnotes for pricing details
- Centered, constrained layout for optimal readability
