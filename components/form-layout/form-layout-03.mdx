...
description: "A multi-section form with personal information, workspace settings, and checkbox-based notification preferences."
---

A comprehensive settings form layout featuring personal details, workspace configuration, and checkbox groups for team and usage notification preferences.
...
```bash yarn
yarn dlx shadcn@latest add @blocks/form-layout-03
```

```bash pnpm
pnpm dlx shadcn@latest add @blocks/form-layout-03
```

```bash bun
bunx shadcn@latest add @blocks/form-layout-03
```
</CodeGroup>
...
- Three-section layout with side labels and descriptions
- Personal information section with standard user fields
- Workspace settings with name, visibility, and description
- Grouped checkbox controls for notification preferences
- Team alerts configuration (join requests, activity digest)
- Usage alerts for API, workspace performance, caching, and storage
- Default checked states for important notifications
- Fieldset organization with legends and descriptions
- Disabled fields with contextual help text
