...
description: "A workspace creation form with detailed plan selection, featuring pricing tiers and informational sidebar."
---

A sophisticated workspace creation form with organization selection, region configuration, detailed plan comparison cards, and an informational sidebar.

## Installation

<CodeGroup>
```bash npm
npx shadcn@latest add @blocks/form-layout-05
```

```bash yarn
yarn dlx shadcn@latest add @blocks/form-layout-05
```

```bash pnpm
pnpm dlx shadcn@latest add @blocks/form-layout-05
```

```bash bun
bunx shadcn@latest add @blocks/form-layout-05
```
</CodeGroup>
...
It also requires the following npm package:
...
- Organization and workspace name configuration
- Region selector with multiple geographic options
- Three pricing plans: Creator ($15), Team ($49), and Agency ($99)
- Recommended badge for suggested plan
- Detailed feature lists for each plan with checkmark icons
- Interactive plan selection with visual feedback (border/ring effects)
- Learn more links for additional plan information
- Pricing display with monthly costs
- Informational sidebar card with highlights
- Two-column layout on larger screens
- Icon integration from lucide-react
- Utility function support via cn() helper
