...
```bash
npx shadcn@latest add badge button dropdown-menu label switch textarea
```

<Step>Copy the source code</Step>

Create `components/ai-04.tsx` and paste the component code.
