...
<Tabs>
  <Tab title="CLI">
    ...
    - `@tabler/icons-react`
    - shadcn/ui components: `button`, `select`, `textarea`
  </Tab>
  ...
  <Tab title="Manual">
    <Steps>
      ...
      <Step title="Copy source code">
        Create `components/ai-02.tsx` with code from [blocks.so/r/ai-02.json](https://blocks.so/r/ai-02.json)
      </Step>
    </Steps>
  </Tab>
</Tabs>
