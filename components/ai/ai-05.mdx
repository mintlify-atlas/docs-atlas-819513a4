...
<Step>Install AI Elements</Step>

```bash
npx ai-elements@latest add conversation message prompt-input
```

This component requires the AI Elements library for conversation and message components.
...
```bash
npm install @tabler/icons-react ai
```
...
Create `components/ai-05.tsx` and paste the component code.
